namespace dms{
    ...
    class vector{
        ...
        set(index: number, newPoint: point): point{
            if(index > this.size){
                let filler: point = new point();
    ...
    class figure{
        ...
        private             vertexes:       vector;
    
    
        constructor (name: string = "figure", colorFilling: string = "#fff", colorBorder: string | null = null, vertexes: vector){
    ...
    class triangle extends figure{
        ...
        constructor(identificators: string, color: string = "#fff", border: string | null = null, vertexes: vector){
            let name = "triangle";
